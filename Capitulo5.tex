...
\begin{figure}[h]
    ...
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering \vspace{2cm} \textbf{Diagrama de Arquitectura del Sistema} \vspace{2cm}
    \end{minipage}}
...
\begin{figure}[h]
    \centering
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering \vspace{2cm} \textbf{Diagrama de Contexto} \vspace{2cm}
    \end{minipage}}
...
\begin{figure}[h]
    \centering
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering \vspace{2cm} \textbf{Diagrama de Casos de Uso} \vspace{2cm}
    \end{minipage}}
...
\begin{figure}[h]
    \centering
    \fbox{\begin{minipage}{0.8\textwidth}
        \centering \vspace{2cm} \textbf{Diagrama de Secuencia: Carga de Archivo} \vspace{2cm}
    \end{minipage}}
